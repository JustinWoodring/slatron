      ...
      <aside className="w-64 flex-shrink-0 glass-panel border-r border-[var(--border-color)] flex flex-col z-20">
        ...
        <div className="p-4 border-t border-[var(--border-color)]">
          ...
          <div className="mt-4 text-center">
            <small className="text-[10px] text-[var(--text-secondary)] opacity-10 hover:opacity-50 transition-opacity cursor-default select-none" title="Built by Antigravity">
              Slatron v1.0.0
            </small>
          </div>
        </div>
